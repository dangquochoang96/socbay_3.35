...
class ForgotPasswordScreenBloc
  ...
  Future<void> _checkUserExist(CheckUserExistEvent event,
      Emitter<ForgotPasswordScreenState> emitter) async {
    try {
      var url = Uri.http(AppConfig.instance.values.apiUrl, "/api/user/check",
          {'phone': event.phone});

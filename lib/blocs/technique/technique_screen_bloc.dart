...
class TechniqueScreenBloc extends Bloc<TechniqueScreenEvent, TechniqueScreenState> {
  ...
  FutureOr<void> _mapStartedEventToState(
      TechniqueScreenStartedEvent event, Emitter<TechniqueScreenState> emit) async {
    isLoading = true;
  ...
  FutureOr<void> _mapStartedEventFaToState(TechniqueScreenEvent event,
      Emitter<TechniqueScreenState> emit) async {
    isLoading = true;
    emit(TechniqueScreenInitialState());

...
class HistoryScreenBloc extends Bloc<HistoryScreenEvent, HistoryScreenState> {
  ...
  Future<FutureOr<void>> _mapTabPressEventToState(HistoryScreenTabPressEvent event, Emitter<HistoryScreenState> emit) async {
  ...
  Future<void> _mapBookingDeleteTaskEventToState(BookingDeleteTaskEvent event, Emitter<HistoryScreenState> emit)async {
    isLoading = true;

...
class StaffServiceScreenSaleChangeTypeServiceState
...
class StaffServiceScreenSaleCreateTaskSuccessState
    extends StaffServiceSaleScreenState {
  final int id;
  final bool isSearch;
...
class StaffServiceScreenSaleCreateTaskFailedState
    extends StaffServiceSaleScreenState {
...
class StaffServiceScreenSaleUploadImageFailedState
    extends StaffServiceSaleScreenState {
  final String message;
...
class StaffServiceScreenSaleUploadImageSuccessState
    extends StaffServiceSaleScreenState {
...
class StaffServiceScreenSaleCheckCustomerSuccessState
    extends StaffServiceSaleScreenState {
  final String message;
...
class StaffServiceScreenSaleCheckCustomerFailedState
    extends StaffServiceSaleScreenState {
  final String message;

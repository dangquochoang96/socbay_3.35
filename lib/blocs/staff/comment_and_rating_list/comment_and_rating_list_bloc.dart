...
class CommentAndRatingBloc extends Bloc<CommentAndRatingEvent, CommentAndRatingState> {
  ...
  FutureOr<void> _mapGetListCommentAndRatingEventToState(
      ...
      Emitter<CommentAndRatingState> emit) async {
    isLoading = true;
    await _getProfile();
    await _getRating();
    isLoading = false;
  ...
  Future<void> _getProfile() async {
    var url = Uri.http(AppConfig.instance.values.apiUrl,"/api/user/${App.instance.userApp!.id}");
    try{

...
class TaskProcessedModel {
  ...
  factory TaskProcessedModel.fromJson(Map<String, dynamic> json) => TaskProcessedModel(
    ...
    ? (json["progress"].map<TaskDetailActionModel>(
            (e)=> TaskDetailActionModel.fromJson(e as Map<String, dynamic>)
    )).toList()
    : null,
  ...
  Map<String, dynamic> toJson() => {
    ...
    "progress": List<TaskDetailActionModel>.from(progress!.map((e) => e.toString())),

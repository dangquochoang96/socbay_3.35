...
class _OrderManagerScreenState extends State<OrderManagerScreen> {
  ...
  void initState() {
    ...
    var endInitTime =
        DateTime.now().add(const Duration(seconds: (23 * 60 + 59) * 60));
    _bloc.add(OrderManagerListEvent(
        isRefresh: true,
                ...
                child: Table(
                  ...
                  children: [
                    TableRow(children: [
                      ...
                      Text(_bloc.staffLstOrders[index].tvInsteadDate
                              ?.substring(0, 10) ??
                          "")
                    ]),
                    TableRow(children: [
                      ...
                      Text(_bloc.staffLstOrders[index].tvNextInsteadDate
                              ?.substring(0, 10) ??
                          "")
                    ]),
                    TableRow(children: [
              ...
              ButtonWidget(
                  onTap: () {
                    Navigator.pushNamed(context,
                        Routes.coreReplacementServiceScreen, arguments: {
                      "orderDetail":
                          OrderDetailModel(id: _bloc.staffLstOrders[index].id)
                    });
                  },

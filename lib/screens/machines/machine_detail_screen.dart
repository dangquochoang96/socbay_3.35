        ...
        Padding(
          ...
          child: Table(
            ...
            children: [
              TableRow(
                children: [
                  const Text("Tiền thuê/tháng: ",
                      style:
                          TextStyle(fontSize: 15, fontWeight: FontWeight.w400)),
                  Text(orderRent.monthlyRent != null
              ...
              TableRow(
                children: [
                  const Text("Đã thanh toán: ",
                      style:
                          TextStyle(fontSize: 15, fontWeight: FontWeight.w400)),
                  Text(orderRent.amountPaid != null
                ...
                child: Table(
                  ...
                  children: [
                    ...
                    TableRow(children: [
                      ...
                      Text(((Decimal.parse(_bloc.ordersModel[index].price ?? "0") -
                                      Decimal.parse(_bloc.ordersModel[index]
                                                  .truTichDiem ??
                                              "0") *
                                          heso -
                                      Decimal.parse(
                              ...
                              ? (Decimal.parse(
                                  ...
                                  Decimal.parse(_bloc.ordersModel[index].truTichDiem ?? "0") *
                                      heso -
                                  Decimal.parse(
                                      _bloc.ordersModel[index].chietKhau ?? "0"))
                              : 0)
                          .toString()
                          .toVND())
                    ])

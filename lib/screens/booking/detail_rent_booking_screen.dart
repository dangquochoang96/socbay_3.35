...
class _DetailRentBookingScreenState extends State<DetailRentBookingScreen> {
  late DetailRentBookingBloc _bloc;
  late RentTaskScreenSaleBloc _taskScreenSaleBloc;
    ...
    Navigator.pushNamed(context, Routes.editRentServiceScreen,
      ...
      if (value == null) {
        ...
        if (result != null) {
          setState(() {
            _bloc.add(DetailBookingStartedEvent());
            _taskScreenSaleBloc.add(const StaffTaskScreenGetTaskAssigedEvent(isRefresh: true));
            _taskScreenSaleBloc.add(const StaffTaskScreenGetTaskByDayEvent(isRefresh: true));
          });
        }
      }
    });
  ...
  void _createOrder(int id) {
    Navigator.pushNamed(context, Routes.createRentOrderScreen,
        arguments: {'id': id});
  }
}

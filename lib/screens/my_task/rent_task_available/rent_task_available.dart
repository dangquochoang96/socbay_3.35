...
class RentTaskAvailableTabSale extends StatefulWidget {
  const RentTaskAvailableTabSale({Key? key}) : super(key: key);

  @override
  State<RentTaskAvailableTabSale> createState() => _RentTaskAvailableTabState();
}

class _RentTaskAvailableTabState extends State<RentTaskAvailableTabSale> {

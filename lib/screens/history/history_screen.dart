...
class _HistoryScreenState extends State<HistoryScreen>
  ...
  void initState() {
    ...
    _bloc.add(HistoryScreenTabPressEvent(1));
    _feedbackController = TextEditingController();
    _tabHistoryController = TabController(
      length: 2,
      initialIndex: _bloc.state.initialIndex,
      vsync: this,
    );
    _tabHistoryController.addListener(() {
      setState(() {
        if (_tabHistoryController.index !=
          ...
          _bloc.add(HistoryScreenTabPressEvent(_tabHistoryController.index));
        }
      });
    });
  }
    ...
    return Scaffold(
        ...
        body: LoadingIndicator(
            ...
            child: RefreshIndicator(
              onRefresh: () async {
                _bloc.add(
                    HistoryScreenTabPressEvent(_tabHistoryController.index));
              },
              child: Column(
                children: [
                  TabBar(
                ...
                TableRow(
                  children: [
                    ...
                    Text(taskModel.getStatus(),
                        style:
                            const TextStyle(fontSize: 15, color: ColorUtil.red))
                  ],
                ),
                TableRow(children: [
                  Container(

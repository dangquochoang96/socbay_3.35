...
class CommentTechniqueListScreen extends StatefulWidget {
  ...
  State<CommentTechniqueListScreen> createState() =>
      _CommentTechniqueListScreenState();
}

class _CommentTechniqueListScreenState
    extends State<CommentTechniqueListScreen> {
  late CommentTechniqueBloc _bloc;
  List<OrderDetailModel>? _lstOrder;
  @override
  void initState() {
    _bloc = BlocProvider.of(context);
    _bloc.add(const CommentTechniqueListEvent());
    super.initState();
  }
